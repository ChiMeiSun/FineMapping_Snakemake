...
phenos_fp = ['BW32','EW40','EW50','EW70', 'EN2','EN3','EN4','EN5','EN6','EN7','EN8','EN10','EN11','EN12','EN13']
...
rule all:
    input:
        ...
        "PLOTS/manplot/metaGWAS/ENlate_all.png",
        ...
        expand("PLOTS/BFMAP/{pheno}/{pheno}_{gen}.pdf", pheno=phenos_fp, gen='all'),
        expand("PLOTS/BFMAP/{pheno}/recalc_{pheno}_{gen}.pdf", pheno=phenos_fp, gen='all'),
